...
- **The README a stranger follows** — install, claim, revoke, plus the two or three copy-paste automation examples ADR-0036 committed to (chime before bottle end, announce a Feed due), and one tile-card `name:` override example (long German names truncate on narrow tiles); spec-assembly territory.
